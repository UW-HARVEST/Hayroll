...
![A hayroll](images/hayroll-200x200.png)

Hayroll wraps the [c2rust](https://github.com/immunant/c2rust) tool for converting
...
```sh
diff hayroll-output/xxx.{split}.seeded.rs hayroll-output/xxx.rs
```

- `xxx.{split}.seeded.rs` is generated by C2Rust and contains Rust code with C macros
